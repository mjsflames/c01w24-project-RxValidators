			...
			<div className="flex w-full h-[650px] items-center justify-center bg-cover bg-no-repeat" style={{backgroundImage: `url(${log})`}}>
                <form onSubmit={handleClick} className="ml-auto mr-auto w-1/3">
                    <div class="rounded-xl bg-gray-200 bg-opacity-60 px-16 py-10 shadow-lg backdrop-blur-md max-sm:px-8">
                        ...
                        <div className="relative z-0 w-full mb-8 group">
                            <input id="initials" type="text" oninput="this.value = this.value.toUpperCase()" maxLength="2" className="block py-2.5 w-full text-l text-gray-900 bg-transparent border-0 border-b-2 border-gray-800 appearance-none focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder="" required />
                        ...
                        <div className="relative z-0 w-full mb-8 group">
                            <input id="parx_code" maxLength="8" oninput="this.value = this.value.toUpperCase()" className="block py-2.5 w-full text-l text-gray-900 bg-transparent border-0 border-b-2 border-gray-800 appearance-none focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder="" required/>
