      ...
      <div className="flex flex-col mx-auto mb-12 text-center">
        ...
        <table className="w-full mt-10 mb-20 text-sm rtl:text-right text-gray-500">
          ...
          <tbody>
            {data && data.map((item) => (
              <>
                <tr className="w-full text-left text-black border-t border-white odd:bg-white/60 even:text-white even:bg-[#0a0e1a]/50 hover:">
                  ...
                  <td className="px-2 py-3 w-1/2 truncate max-w-md">{item.comments}
