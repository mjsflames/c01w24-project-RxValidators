            ...
            <div className="w-screen lg:w-1/2 h-screen bg-white z-20 flex items-center absolute lg:relative justify-center">
				<form className=":w-1/2 mx-auto z-50 ">
					<div className="flex flex-col items-center [&>*]:text-gray-500 mb-12">
                        ...
                        <p>Please enter your initials and create a username and password.</p>
                        <p>Addresses are used for Green Resources and mailing Discovery Passes.</p>
                    </div>
                    <div className="mb-5">
						<label className="block mb-2 text-sm font-medium text-gray-600 ">Enter Your First/Last Name Initials Only <br />(Example: John Doe = JD)</label>
						<input id="patinitials" type="text" maxlength="2" oninput="this.value = this.value.toUpperCase()" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="Initials" required/>
					</div>
                    <div className="mb-5">
						<label className="block mb-2 text-sm font-medium text-gray-600 ">Create a Username</label>
                    ...
                    <div className="mb-5">
						<label className="block mb-2 text-sm font-medium text-gray-600 ">Enter an Address (Optional)</label>
						<input id="address" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="Address"/>
					</div>
