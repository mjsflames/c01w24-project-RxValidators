        ...
        <div className="grid grid-cols-2 gap-y-0 w-screen-1/3 h-1/3 items-end">
          ...
          <div className="col-span-2 mt-32 text-center mb-8">
            ...
            <button
              ...
              className="text-white bg-[#3b5998] hover:bg-[#3b5998]/90 font-medium rounded-lg text-sm h-12 w-64 text-center"
            >
              Learn More About PaRx
            </button>
          </div>
          <Link to="/PatientLogRX">
            <button className="text-white bg-[#3b5998] hover:bg-[#3b5998]/90 font-medium rounded-lg text-sm ml-3 mr-16 h-12 w-64 text-center">
              Log Prescriptions
            </button>
          </Link>
          <Link to="/patientPrescriptions">
            <button className="text-white bg-[#3b5998] hover:bg-[#3b5998]/90 font-medium rounded-lg text-sm mr-3 h-12 w-64 text-center align-middle">
