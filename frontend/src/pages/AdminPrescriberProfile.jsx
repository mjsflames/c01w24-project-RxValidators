...
import AdminExtraPres from "../components/AdminExtraPres";
...
const AdminPrescriberProfile = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const res = await api.get("/auth/listPrescribers");
  ...
  return (
    <>
      <PageHeader
        ...
        desc="Below is a list of Prescriber profiles."
      />
      <ContentContainer>
        <div className="mx-auto text-center">
          <h1 className="text-3xl underline font-bold !text-gray-900  mb-5">All Prescriber Profiles</h1>
                                    ...
                                    <div className="relative w-auto mx-auto">
                                        <div className="border-0 rounded-lg relative flex flex-col w-full bg-white outline-none px-10"> 
                                            ...
                                            <div className="flex flex-row justify-center mb-5">
                                                <button id="deletelog" onClick={() => {deleteHandler(item.prescriber_code)}} className="bg-green-200 hover:bg-green-200/40 text-black border rounded-full p-2.5 mr-10">Yes, proceed</button>
