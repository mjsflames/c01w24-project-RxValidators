...
gnome-terminal --tab --title="Authentication Service" --working-directory=$PWD/backend/database_functions -- /bin/bash -c "source .venv/bin/activate; python database_Authentications.py; exec bash" &
