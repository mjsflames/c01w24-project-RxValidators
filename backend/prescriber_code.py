...
# TODO: implement this later with database
# This function will generate the index for the unique prescriber codes based on the province
def get_index(province):
