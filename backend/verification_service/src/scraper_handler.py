...
def _process_request(file_data, id):
    ...
    if validate_file(file_data) == False: return "Invalid file format, please upload a CSV file with the correct headers"
    ...
    for index, row in df.iterrows():
        ...
        processing[id] = f"Scraping in Progress: Passed - {passed_count}, Failed - {failed_count}"
